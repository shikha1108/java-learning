...
import static org.junit.jupiter.api.Assertions.assertTrue;
    ...
    class ListExamplesTest {
        org.example.ListExamples listExamples = new org.example.ListExamples();
        ...
        void findMiddle() {
            List<Integer> nums = List.of(10, 20, 30, 40, 50);
            List<Integer> nums1 = List.of(10, 20, 40, 50, 60);
            Integer result = listExamples.findMiddle(nums);
            Integer result1 = listExamples.findMiddle(nums1);
        ...
        void middlePlusTwo() {
            List<Integer> nums = List.of(10, 20, 30, 40, 50);
            List<Integer> nums1 = List.of(1, 2, 3, 4, 5);
            Integer result = listExamples.middlePlusTwo(nums);
            Integer result1 = listExamples.middlePlusTwo(nums1);
            assertEquals(50, result);
        ...
        @Test
        void secondMaximum() {List<Integer> numbers = new ArrayList<>();
            numbers.add(10);
            numbers.add(20);
            numbers.add(30);
            numbers.add(40);
